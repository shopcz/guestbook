...
class Pager {   
    ...
    public function __construct($p_totalNum, $p_pageIndex, $p_pageSize = 10,$p_initNum=3,$p_initMaxNum=10) {   
...
//{$this->CurrentUrl}={$this->TotalPages}   
    public function GetPagerContent() {   
        $str = "<form action='?page' method='get'>";
        ...
        */  
		...
		//$str .= "\n"."&nbsp;页次："."".($this->pageIndex).""."/"."".$this->totalPagesCount.""."页"."&nbsp;共"."".$this->totalNum.""."条记录"."\n";
		
		$str .= "转
<input class='wenbenkuang' value='".@$_GET['page']."' maxlength='5' size='2' name='page' tyep='TEXT'></input>
页
<input class='go-wenbenkuang gray' type='submit' value='GO'></input>";
